function computeAllModelChoice_batchLGG(pathExperiments,maxOrder,nBoot,imbalance,nBatch,matlabPATH,seed)
% -------------------------------------------------------------------------
% function computeAllModelChoice_batchLGG(pathExperiments,maxOrder,nBoot,imbalance,nBatch,matlabPATH,seed)
% -------------------------------------------------------------------------
% DESCRIPTION: 
...
for i = 1:nBatch
    ...
    for j = 1:numel(param{i})
        fprintf(fid,['computeAllModelChoice_LGG(pathSet,pathModels,training,param{',num2str(i),'}{',num2str(j),'},maxOrder,nBoot,imbalance,seed)\n']);
    end
