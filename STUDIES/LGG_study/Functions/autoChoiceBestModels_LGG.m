function autoChoiceBestModels_LGG(pathExperiments,fSetNames,nameOutcomes,metric,maxOrder,pathFig)
% -------------------------------------------------------------------------
% function autoChoiceBestModels_LGG(pathExperiments,fSetNames,nameOutcomes,metric,maxOrder,pathFig)
% -------------------------------------------------------------------------
% DESCRIPTION: 
...
n = 0;
order = [3,4,3,3,  4,4,3,3,   4,4,4,2,  3,5,4,4]; % For 'nonIDH1', IDHcodel, 'progression', 'lowGrade'
