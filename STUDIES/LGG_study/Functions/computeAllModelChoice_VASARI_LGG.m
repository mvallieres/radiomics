function computeAllModelChoice_VASARI_LGG(pathSet,pathModels,outcomes,param,maxOrder,nBoot,imbalance,seed)
% -------------------------------------------------------------------------
% function computeAllModelChoice_VASARI_LGG(pathSet,pathModels,outcomes,param,maxOrder,nBoot,imbalance,seed)
% -------------------------------------------------------------------------
% DESCRIPTION: 
...
%             --> Ex: '/myProject/WORKSPACE/VASARI/FSET'
...
%          --> Ex: 54288
% -------------------------------------------------------------------------
% OUTPUTS: Mutivariable models are saved in a folder named 'MODELS'.
% -------------------------------------------------------------------------
