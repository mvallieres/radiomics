function calcAllNonTextureFeatures_batchHN(pathData,pathNonText,namePT,nameCT,nameROI,outcomes,featType,nBatch,matlabPATH)
% -------------------------------------------------------------------------
...
features = {'SUVmax','SUVpeak','SUVmean','aucCSH','TLG','PercentInactive','gETU','Volume','Size','Solidity','Eccentricity','Compactness'};
...
for i = 1:nBatch
    ...
    fprintf(fid,['calcAllNonTextureFeatures_HN(pathData,pathNonText,namePT(indValid(patients{',num2str(i),'})),nameCT(indValid(patients{',num2str(i),'})),nameROI(indValid(patients{',num2str(i),'})),featType)\n']);
