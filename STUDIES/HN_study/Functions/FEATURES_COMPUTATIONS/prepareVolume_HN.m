function [ROIonly,levels,ROIbox,maskBox] = prepareVolume_HN(volume,mask,scanType,pixelW,sliceS,R,scale,textType,quantAlgo,Ng)
% -------------------------------------------------------------------------
...
if nargin > 8
    ...
    elseif strcmp(quantAlgo,'Equal')
        quantization = @(x,y) equalQuantization_HN(x,y);
