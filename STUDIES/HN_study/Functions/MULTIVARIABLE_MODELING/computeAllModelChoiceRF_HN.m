function computeAllModelChoiceRF_HN(pathSet,pathModels,training,param,maxOrder,nBoot,imbalance,seed)
% -------------------------------------------------------------------------
...
[models] = featureSelectionRF_HN(fSet.Data,fSet.Categories,outcome,maxOrder,nBoot,fSet.Info,imbalance,seed);
