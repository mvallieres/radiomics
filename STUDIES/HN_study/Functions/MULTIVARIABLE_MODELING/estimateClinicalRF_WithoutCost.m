function estimateClinicalRF_WithoutCost(pathRF,nSplit,nBoot,seed)
...
fSetNames = {'PET','CT','CT'}; nFset = 1;% Here, only 'PET' is tested for Loco, 'CT for 'Distant' and 'CT' for 'Death' ('f' was replace by 'o' in lines 32 and 62)
