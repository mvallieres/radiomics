function displayKaplanMeierRF_HN(pathResults,nameOutcomes,nameSets,pathFig,thresholds)
% - pathFig: Full path to where figure is saved without
...
for o = 1:nOutcomes
    ...
    set(gca,'FontSize',12)
    titleName = ['Kaplan-Meier (RF): ',nameOutcome,'_{',nameSets{o},'}'];
