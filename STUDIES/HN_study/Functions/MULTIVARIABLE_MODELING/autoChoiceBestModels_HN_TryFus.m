function autoChoiceBestModels_HN_TryFus(pathExperimentsBinary,pathExperimentsTime,fSetNames,nameOutcomes,metric,maxOrder,pathFig)
% -------------------------------------------------------------------------
...
order = [8,3,3,4,6,3,3,5,4,3,6,5]; % Including SEP and FUSED, CHANGE ACCORDINGLY
