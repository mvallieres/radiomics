function displayKaplanMeierCR_HN(pathResults,nameOutcomes,nameSets,pathFig)
...
for o = 1:nOutcomes
    ...
    elseif strcmp(nameOutcome,'DeathSign')
        name = 'Survival probability';
    elseif strcmp(nameOutcome,'DeathSignComplete')
        name = 'Survival probability';
    end
    ...
    set(gca,'FontSize',12)
    titleName = ['Kaplan-Meier (CR): ',nameOutcome,'_{(',nameSets{o},')}'];
