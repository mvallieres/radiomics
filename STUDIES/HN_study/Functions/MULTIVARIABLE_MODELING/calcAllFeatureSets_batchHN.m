function calcAllFeatureSets_batchHN(pathMINE,pathExperiments,setSize,alpha,delta,nBoot,nBatch,matlabPATH,seed)
% -------------------------------------------------------------------------
...
for i = 1:nBatch
    ...
    for j = 1:numel(param{i})
        fprintf(fid,['calcAllFeatureSets_HN(pathSet,training,pathMINE,param{',num2str(i),'}{',num2str(j),'},setSize,alpha,delta,nBoot,seed,',num2str(i),')\n']);
    end
