function organizeRFexperiments_HN_Old(pathWORK,pathExperimentTextures,pathRF,nameOutcomes,fSetNames)
...
cd(pathExperimentTextures)
for o = 1:nOutcomes
    results_PT = load(['testResultsLR_','PET','_',nameOutcomes{o}]); results_PT = struct2cell(results_PT); results_PT = results_PT{1};
    results_CT = load(['testResultsLR_','CT','_',nameOutcomes{o}]); results_CT = struct2cell(results_CT); results_CT = results_CT{1};
