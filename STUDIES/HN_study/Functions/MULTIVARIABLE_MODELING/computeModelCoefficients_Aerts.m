function computeModelCoefficients_Aerts(pathExperiments,imbalance,seed)
% -------------------------------------------------------------------------
...
% COMPUTATIONS
[coeff,response,modelCI] = computeModelCoefficients_HN(finalModel.Data,training.Death.outcome,imbalance,seed);
