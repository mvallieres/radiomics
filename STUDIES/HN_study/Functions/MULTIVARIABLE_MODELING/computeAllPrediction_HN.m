function computeAllPrediction_HN(pathModels,pathResults,training,param,maxOrder,nBoot,imbalance,seed)
% -------------------------------------------------------------------------
...
for j = 1:maxOrder
    ...
    [orderResults] = predictionPerformanceEstimation_HN(data,outcome,nBoot,imbalance,seed);
