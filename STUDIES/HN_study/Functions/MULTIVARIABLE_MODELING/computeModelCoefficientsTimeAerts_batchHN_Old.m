function computeModelCoefficientsTimeAerts_batchHN_Old(pathExperimentsTime,nExp,nBatch,matlabPATH,seed)
% -------------------------------------------------------------------------
...
for exp = 1:nExp
    cd(fullfile(pathExperimentsTime,['Experiment',num2str(exp)])), load('training')
