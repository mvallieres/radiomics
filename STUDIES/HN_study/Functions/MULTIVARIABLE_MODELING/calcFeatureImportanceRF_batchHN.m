function calcFeatureImportanceRF_batchHN(pathRF,nPerms,matlabPATH,seed)
...
for o = 1:nOutcomes
    for f = 1:nFset
        ...
        fprintf(fid,['[percentAUCdecrease,varNames] = calcFeatureImportanceRF_HN_Old(pathRF,nPerms,nameOutcomes{',num2str(o),'},fSetNames{',num2str(f),'},seed);\n']);
