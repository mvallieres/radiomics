function diplayFinalModels_HN(pathWORK,outcomes)
% -------------------------------------------------------------------------
% function diplayFinalModels_HN(pathWORK,outcomes)
% -------------------------------------------------------------------------
% DESCRIPTION: 
% This function displays the final models for all analyzed outcomes in the
% HN study, in terms of: multivariable model response, model variables, and 
...
for o = 1:nOutcomes
    cd([pathWORK,'/FINAL_MODELS/',nameOutcomes{o}])
    ...
    fprintf(['\n\n --> THE FINAL MULTIVARIABLE MODEL FOR ''%s'' OUTCOME IS:\n\n'...
