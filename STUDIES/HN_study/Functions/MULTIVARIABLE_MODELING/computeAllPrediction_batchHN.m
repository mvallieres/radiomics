function computeAllPrediction_batchHN(pathExperiments,maxOrder,nBoot,imbalance,nBatch,matlabPATH,seed)
% -------------------------------------------------------------------------
...
for i = 1:nBatch
    ...
    for j = 1:numel(param{i})
        fprintf(fid,['computeAllPrediction_HN(pathModels,pathResults,training,param{',num2str(i),'}{',num2str(j),'},maxOrder,nBoot,imbalance,seed)\n']);
    end
