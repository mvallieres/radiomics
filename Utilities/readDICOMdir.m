...
try sData{2}.scan.pixelW = dicomHeaders(1).PixelSpacing(1); catch sData{2}.scan.pixelW = []; end
try sData{2}.scan.sliceT = dicomHeaders(1).SliceThickness; catch sData{2}.scan.sliceT = []; end
sData{2}.type = type;
