...
h = plot(xb,yb,esymbol,'LineWidth',2,'MarkerSize',4,'Marker','square'); hold on % Modification by Martin Vallières: June 8, 2015
h = [h;plot(x,y,symbol,'LineWidth',6,'MarkerSize',18,'MarkerFaceColor',symbol(end),'MarkerEdgeColor',symbol(end))]; % Modification by Martin Vallières: June 8, 2015
